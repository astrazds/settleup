/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 81d2989a2dbcd1c0ac9a91474c667b3c)
// Runtime types generated with workerd@1.20260526.1 2026-05-27 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	EVENT_REALTIME: DurableObjectNamespace<import("./src/index").EventRealtimeRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EventRealtimeRoom";
	}
