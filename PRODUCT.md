...
Success means a group can create a private-by-link event, add participants and expenses, see balances, record settlement payments, and return later without losing active drafts or needing to understand accounting. The root app starts with event creation, not a sample event.
