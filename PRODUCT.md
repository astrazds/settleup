...
Success means a group can create a private-by-link event, manage participants, add expenses, see balances, record or correct settlement payments, and return later without losing active drafts or needing to understand accounting. The root app starts with event creation, not a sample event.
